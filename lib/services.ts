...
export const servicesBySlug: Record<ServiceSlug, ServiceDefinition> = {
  "home-organisation": {
    ...
    whyMe: [
      "I’m patient, methodical, and used to juggling school and commitments, and I know how clutter builds up when life is busy.",
  ...
  tutoring: {
    ...
    icon: BookOpen,
    metaDescription:
      "Primary tutoring in maths, science, and reading; Year 7 and 8 maths, in-home or online, Brighton Central, Apex Assist.",
    intro:
    ...
    note: "I’m working toward involving trusted friends, all at an advanced level, for extra timeslots when I’m booked or you need another slot. I only suggest people I’d trust with my own reputation. Ask when you text.",
  },
  "tech-help": {
    slug: "tech-help",
    title: "Tech help",
  ...
  gardening: {
    ...
    icon: Sprout,
    metaDescription:
      "Gardening and outdoor work in Brighton Central, from tidy-ups to team weekend jobs, Apex Assist.",
    intro:
    ...
    whyMe: [
      ...
      "If a job needs skills, gear, or licences I don’t have, I’ll say so upfront, with no guesswork.",
    ],
    included: [
  ...
  "dog-walking": {
    ...
    intro:
      "When work, school runs, or travel get in the way, dogs still need their walk. I offer straightforward dog walking for dogs that are happy with a new walker after we’ve met, with the same routes and habits you prefer, leash and harness as you specify.",
    whyMe: [
      ...
      "I’m easy to reach by text, which helps for last-minute changes, a quick check-in after the walk, or questions.",
    ],
    included: [
    ...
    note: "Every dog is different, so tell me about temperament, vet contacts, and walking rules (reactivity, other dogs, traffic). If I’m unavailable, I’m working toward a small group of trusted friends to cover extra times, only with your OK.",
  },
};
